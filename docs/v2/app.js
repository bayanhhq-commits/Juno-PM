...
const VIEW_META = {
  command: ["Portfolio workspace", "Command Center", "Run portfolio analysis"],
...
const STORAGE_KEY = "juno-product-os-v2";
...
function renderAll() {
  ...
  state.mode = hasApprovedStrategy ? "Strategy Mode" : "Quality Mode";
